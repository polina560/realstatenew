 ...
 */
final class GalleryImageController extends AdminController
{
    /**
     * {@inheritdoc}
     */
     ...
     */
    public function actionIndex(int $id_gallery): string
    {
     ...
     * @throws InvalidConfigException
     */
    public function actionCreate(int $id_gallery, string $redirect = null): Response|string
    {
        $model = new GalleryImage();
    ...
    public function actionDelete(int $id): Response
    {
        ...
        return $this->redirect(UserUrl::setFilters(GalleryImageSearch::class));
    }
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    private function findModel(int $id): GalleryImage
    {
